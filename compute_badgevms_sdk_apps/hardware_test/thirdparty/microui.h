...
enum { MU_COMMAND_JUMP = 1, MU_COMMAND_CLIP, MU_COMMAND_RECT, MU_COMMAND_TEXT, MU_COMMAND_ICON, MU_COMMAND_MAX };
...
enum { MU_RES_ACTIVE = (1 << 0), MU_RES_SUBMIT = (1 << 1), MU_RES_CHANGE = (1 << 2) };
...
enum { MU_MOUSE_LEFT = (1 << 0), MU_MOUSE_RIGHT = (1 << 1), MU_MOUSE_MIDDLE = (1 << 2) };
...
int  mu_checkbox(mu_Context *ctx, char const *label, int *state);
